...
cmd.load("../../../data/W1.pdb", quiet=False)
cmd.load("W1.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "W1.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "W1.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
