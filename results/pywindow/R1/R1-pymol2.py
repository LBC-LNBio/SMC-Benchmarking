...
cmd.load("../../../data/R1.pdb", quiet=False)
cmd.load("R1.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "R1.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "R1.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
