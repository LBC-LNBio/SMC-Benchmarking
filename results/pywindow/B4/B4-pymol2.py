...
cmd.load("../../../data/B4.pdb", quiet=False)
cmd.load("B4.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "B4.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "B4.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
