...
cmd.load("../../../data/H1.pdb", quiet=False)
cmd.load("H1.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "H1.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "H1.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
