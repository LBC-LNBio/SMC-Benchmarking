...
cmd.load("../../../data/B1.pdb", quiet=False)
cmd.load("B1.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "B1.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "B1.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()