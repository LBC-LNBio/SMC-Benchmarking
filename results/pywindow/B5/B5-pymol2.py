...
cmd.load("B5.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "B5.pywindow", 0, max(stored.b))
cmd.ramp_new("radius", "B5.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
