...
cmd.load("B8.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "B8.pywindow", 0, max(stored.b))
cmd.ramp_new("radius", "B8.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
