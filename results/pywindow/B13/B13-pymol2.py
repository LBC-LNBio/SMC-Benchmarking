...
cmd.load("B13.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "B13.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "B13.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()
