...
cmd.load("../../../data/F1.pdb", quiet=False)
cmd.load("F1.pywindow.pdb", quiet=False)
...
cmd.spectrum("b", "blue_white_red", "F1.pywindow", [0, max(stored.b)])
cmd.ramp_new("radius", "F1.pywindow", [0, max(stored.b)], ["blue", "white", "red"])
cmd.orient()