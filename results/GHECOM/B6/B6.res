...
#OUTPUTFILENAME    ./results/GHECOM/B6/B6.res
#DATE    Jan 13,2023 18:39:23
#COMMAND ghecom -M M -ipdb ./hosts/B6.pdb -opocpdb ./results/GHECOM/B6/B6.pocket.pdb -opdb ./results/GHECOM/B6/B6.pocketness.pdb -ores ./results/GHECOM/B6/B6.res -atmhet B -gw 0.8 -rlx 10
#COMMENT INPUT_RECEPTOR_PDB_FILE:./hosts/B6.pdb
#COMMENT NATOM_OF_RECEPTOR:82
#COMMENT grid_width  0.800 A VdW volume: 1941 grids, 993.79 AAA
...
#COLUMN 13|pocketness_clus 5 |sum of 1/[Rpocket_for_pocketcluster 5] /(1/[Rmin]*[vol of shell]) (%)
   1  - UNK 100.00  9.836 82  0   1.15   1.15   0.00   0.00   0.00   0.00
