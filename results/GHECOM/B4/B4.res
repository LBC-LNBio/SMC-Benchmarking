...
#COMMAND ghecom -M M -ipdb ./hosts/B4.pdb -opocpdb ./results/GHECOM/B4/B4.pocket.pdb -opdb ./results/GHECOM/B4/B4.pocketness.pdb -ores ./results/GHECOM/B4/B4.res -atmhet B -gw 0.8 -rlx 8
...
#COMMENT MAX_RLARGE:8.000000
#COMMENT BIN_RLARGE:0.500000
#COMMENT RSMALL: 1.870
#MULSC_PROBE: NRADIUS 13
...
#OUTSIDE_OF_MAX_RADIUS       8.500 Ang  0.118 1/Ang 
...
#COLUMN 13|pocketness_clus 5 |sum of 1/[Rpocket_for_pocketcluster 5] /(1/[Rmin]*[vol of shell]) (%)
   1  - UNK 100.00  7.683 196  0   1.98   1.98   0.00   0.00   0.00   0.00
