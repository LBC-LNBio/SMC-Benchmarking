...
#OUTPUTFILENAME    ./results/GHECOM/B5/B5.res
#DATE    Jan 28,2023 11:51:44
#COMMAND ghecom -M M -ipdb ./hosts/B5.pdb -opocpdb ./results/GHECOM/B5/B5.pocket.pdb -opdb ./results/GHECOM/B5/B5.pocketness.pdb -ores ./results/GHECOM/B5/B5.res -atmhet B -gw 0.8 -rlx 10
#COMMENT INPUT_RECEPTOR_PDB_FILE:./hosts/B5.pdb
#COMMENT NATOM_OF_RECEPTOR:82
#COMMENT grid_width  0.800 A VdW volume: 1913 grids, 979.46 AAA
...
#COLUMN 13|pocketness_clus 5 |sum of 1/[Rpocket_for_pocketcluster 5] /(1/[Rmin]*[vol of shell]) (%)
   1  - UNK 100.00  9.850 82  0   0.68   0.68   0.00   0.00   0.00   0.00
