...
#OUTPUTFILENAME    ./results/GHECOM/O1/O1.res
#DATE    Nov 10,2022 16:34:58
#COMMAND ghecom -M M -ipdb ./hosts/O1.pdb -opocpdb ./results/GHECOM/O1/O1.pocket.pdb -opdb ./results/GHECOM/O1/O1.pocketness.pdb -ores ./results/GHECOM/O1/O1.res -atmhet B -gw 0.8 -rlx 10.0
#COMMENT INPUT_RECEPTOR_PDB_FILE:./hosts/O1.pdb
#COMMENT NATOM_OF_RECEPTOR:92
#COMMENT grid_width  0.800 A VdW volume: 2039 grids, 1043.97 AAA
...
#COLUMN 13|pocketness_clus 5 |sum of 1/[Rpocket_for_pocketcluster 5] /(1/[Rmin]*[vol of shell]) (%)
   1  - UNK 100.00  9.733 92  0   2.25   1.98   0.27   0.00   0.00   0.00
