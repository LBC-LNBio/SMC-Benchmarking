...
#OUTPUTFILENAME    ./results/GHECOM/B14/B14.res
#DATE    Jan 13,2023 18:39:26
#COMMAND ghecom -M M -ipdb ./hosts/B14.pdb -opocpdb ./results/GHECOM/B14/B14.pocket.pdb -opdb ./results/GHECOM/B14/B14.pocketness.pdb -ores ./results/GHECOM/B14/B14.res -atmhet B -gw 0.8 -rlx 10
#COMMENT INPUT_RECEPTOR_PDB_FILE:./hosts/B14.pdb
#COMMENT NATOM_OF_RECEPTOR:264
#COMMENT grid_width  0.800 A VdW volume: 6101 grids, 3123.71 AAA
...
#COLUMN 13|pocketness_clus 5 |sum of 1/[Rpocket_for_pocketcluster 5] /(1/[Rmin]*[vol of shell]) (%)
   1  - UNK 100.00  9.380 264  0   2.52   2.52   0.00   0.00   0.00   0.00
