...
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/B1/B1.KVFinder.output.pdb", quiet=False)
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/B1/B1.surface.pdb", quiet=False)
