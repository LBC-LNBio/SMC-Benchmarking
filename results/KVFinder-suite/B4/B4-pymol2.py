...
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/B4/B4.KVFinder.output.pdb", quiet=False)
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/B4/B4.surface.pdb", quiet=False)
