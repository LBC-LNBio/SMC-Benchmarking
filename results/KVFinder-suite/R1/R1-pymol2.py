...
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/R1/R1.KVFinder.output.pdb", quiet=False)
cmd.load("/home/jvsguerra/remote-repos/moc-benchmarking/results/KVFinder-suite/R1/R1.surface.pdb", quiet=False)
